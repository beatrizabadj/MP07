<!-- resources/views/usuaris/index.blade.php -->
...
<ul>
    <?php $__currentLoopData = $usuaris; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $usuari): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <li>
            <?php echo e($usuari->nom); ?> - <?php echo e($usuari->email); ?> 
...
<a href="<?php echo e(route('usuaris.create')); ?>">Crear Nou Usuari</a>
<?php /**PATH C:\xampp\htdocs\exercicis MP07\UF3\MP07_S4_UF3_PRAC\exercici 2\CrudQueryBuilder\resources\views/usuaris/index.blade.php ENDPATH**/ ?>